...
class FaithRouter {
  static goto(BuildContext context, String routeName, String mode,
      {dynamic parameter}) {
    switch (mode) {
  ...
  static Route<dynamic> appRoute(RouteSettings settings) {
    try {
      ...
      return new RouteTransition(
          builder: (_) => routes[RouterMode.ROUTE_404], settings: settings);
    }
  }
...
//    if (settings.isInitialRoute) return child;
    return new CupertinoPageTransition(child: child, linearTransition: true, primaryRouteAnimation: animation, secondaryRouteAnimation: secondaryAnimation);
  }*/
}
